...
public class FacebookManager : MonoBehaviour
{
     [SerializeField] private TMP_Text _friendsListPlayingTheGame;
        ...
        public void Share()
        {
            FB.ShareLink(new Uri("http://google.com"), "Zajeban je ovaj FB SDK", new System.Uri("C:'\'Users\vikop\'OneDrive\'Pictures\'IMUM_COELI_HELIOCENTRIC_SIDE_A.jpg").ToString());
        }
